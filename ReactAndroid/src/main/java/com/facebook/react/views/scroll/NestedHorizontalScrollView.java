...
/**
 * This is a copy-pasta version of HorizontalScrollView from API Level 25 with
 * support for nested scrolling. It was adapted in the manner of
 * NestedScrollView, which is to say that it's a huge hack job.
 *
 * The original class description follows.
 *
 * ===
 *
 ...
 */
public class NestedHorizontalScrollView extends FrameLayout implements NestedScrollingParent,
  NestedScrollingChild {
    private static final int ANIMATED_SCROLL_GAP = 250;

    private static final float MAX_SCROLL_FACTOR = 0.5f;

    private static final String TAG = "NestedHorizontalScrollView";
    ...
    public NestedHorizontalScrollView(
    ...
    public void addView(View child) {
        if (getChildCount() > 0) {
            throw new IllegalStateException("NestedHorizontalScrollView can host only one direct child");
        }
    ...
    /**
     * @return Returns true this NestedHorizontalScrollView can be scrolled
     */
    ...
    /**
     * Indicates whether this NestedHorizontalScrollView's content is stretched to
     * fill the viewport.
     *
    ...
    /**
     * Indicates this NestedHorizontalScrollView whether it should stretch its content width
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollBy(deltaX, 0, getScrollX(), 0, range, 0,
                            mOverscrollDistance, 0, true) && !hasNestedScrollingParent()) {
    ...
    protected void onOverScrolled(int scrollX, int scrollY,
        ...
        if (!mScroller.isFinished()) {
            ...
            setScrollX(scrollX);
            setScrollY(scrollY);
            invalidateParentIfNeededCompat();
    ...
    private void invalidateParentIfNeededCompat() {
        final ViewParent parent = getParent();
    ...
    public CharSequence getAccessibilityClassName() {
        return NestedHorizontalScrollView.class.getName();
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        final int scrollX = getScrollX();
        ss.scrollOffsetFromStart = scrollX;
        return ss;
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "NestedHorizontalScrollView.SavedState{"
